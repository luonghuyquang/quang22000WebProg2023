...
<head>
  ...
  <!--calculate and generate the relative link-->
    <?php $fromRoot = substr_count(dirname($_SERVER['PHP_SELF']),'/')-1;
      $relativeLink = str_repeat('../', $fromRoot);//the .'root/containerfolder/' will be added here depending on the server structure
      ?>
  <!--local css-->
  <link rel="stylesheet" href="<?php echo $relativeLink.'quang22000layout/style.css'?>">
  <script>
...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo $relativeLink.'index.php'?>">Quang22000</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="<?php echo $relativeLink.'index.php'?>">Home</a>
        </li>
        <li class="nav-item">
  ...
  <div class="row" style="margin-top: 10px; margin-bottom: 10px; margin-right: 5px;">
    <div class="col-sm-3" style="background-color: rgba(228, 235, 194, 0.353);">
      ...
      <h4>Testing area</h4>
      <a class="btn btn-secondary" href="<?php echo $relativeLink.'testcode.php'?>">Testing Area</a>
    </div>
    <div class="col-sm-9">